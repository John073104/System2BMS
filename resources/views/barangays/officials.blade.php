...
@section('content')
<div class="container mx-auto px-4 py-6 ml-54"> <!-- Added ml-64 -->
    <h1 class="text-2xl font-bold mb-4">Barangays</h1>
    <a href="{{ route('barangays.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Add New Barangay Official</a>
